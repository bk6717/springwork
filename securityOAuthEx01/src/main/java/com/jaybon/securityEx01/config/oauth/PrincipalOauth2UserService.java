...
import com.jaybon.securityEx01.config.auth.provider.FaceBookUserInfo;
import com.jaybon.securityEx01.config.auth.provider.GoogleUserInfo;
import com.jaybon.securityEx01.config.auth.provider.OAuth2UserInfo;
